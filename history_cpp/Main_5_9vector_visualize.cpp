...
int main()
{
    ...
    Shader testshader = Shader("shaders/5.9vector_visualize.vs", "shaders/5.9vector_visualize.gs", "shaders/5.9vector_visualize.fs");
    Model ourmodel = Model("models/Nanosuit/nanosuit.obj");
    // ------------------------------------------------------------------
    float cubeVertices[] = {
